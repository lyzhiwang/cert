                            ...
                            <div id="main">
                                ...
                                <div id="content">
                                    ...
                                    <template v-if="form.project === 3">
                                        兹授权<span class="name-span">@{{ form.name }}</span>为扫码有钱微信红包营销系统的全国分销代理。负责扫码有钱全国市场营销和推广工作。
                                    </template>
...
{{--                                <el-input v-model="form.area" placeholder="请输入地区" @input="changeArea"></el-input>--}}
                                <div class="block">
                                    <el-cascader
                                        ...
                                        clearable @change="changeArea"></el-cascader>
                                </div>
                            </el-form-item>
...
{{--                            </el-form-item>--}}
                            <el-form-item label="地区首字母" prop="areaInitial">
                                <el-select v-model="form.areaInitial" placeholder="请选择地区首字母">
                                    <el-option
                                        v-for="item in areaInitialArr"
                                        :label="item"
                                        :value="item">
                                    </el-option>
                                </el-select>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            changeArea() {
                this.splitAreaArr = this.form.area.join('').split('');
                this.areaInitialArr = makePy(this.form.area.join(''));
                console.log(this.areaInitialArr);
